...
exports.updTodo = updTodo;
// 
var ADD_TODO = exports.ADD_TODO = 'ADD_TODO';

var DEL_TODO = exports.DEL_TODO = 'DEL_TODO';

var UPD_TODO = exports.UPD_TODO = 'UPD_TODO';
...
var _AddTodo = __webpack_require__(70);
...
var _DelTodo = __webpack_require__(74);

var _DelTodo2 = _interopRequireDefault(_DelTodo);

var _UpdateTodo = __webpack_require__(75);
   ...
   _createClass(App1, [{
      ...
      value: function render() {
         ...
         return _react2.default.createElement(
            ...
            _react2.default.createElement(_DelTodo2.default, { onDelClick: function onDelClick(id) {
                  return dispatch((0, _actions.delTodo)(id));
               } }),
            _react2.default.createElement(_UpdateTodo2.default, { u: function u(num, text) {
                  return dispatch((0, _actions.updTodo)(num, text));
               } }),
...
exports.default = (0, _reactRedux.connect)(select)(App1);
   ...
   switch (action.type) {
      ...
      case _actions.UPD_TODO:
         ...
         for (var _i = 0; _i < state.length; _i++) {
            ...
            var newObj = Object.assign({}, state[_i]);
            if (newObj.id == num) {
               newObj.text = text;
            }
            s.push(newObj);
...
var DelTodo = function (_React$Component) {
    _inherits(DelTodo, _React$Component);
    ...
    function DelTodo() {
        ...
        _classCallCheck(this, DelTodo);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = DelTodo.__proto__ || Object.getPrototypeOf(DelTodo)).call.apply(_ref, [this].concat(args))), _this), _this.d = function (e) {
            var id = _this.refs.t.value;
            _this.props.onDelClick(id);
        }, _temp), _possibleConstructorReturn(_this, _ret);
    }

    _createClass(DelTodo, [{
        key: "render",
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    null,
                    "id:",
                    _react2.default.createElement("input", { type: "text", ref: "t" }),
                    " "
                ),
                _react2.default.createElement(
                    "button",
...
var UpdateTodo = function (_React$Component) {
    ...
    function UpdateTodo() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = UpdateTodo.__proto__ || Object.getPrototypeOf(UpdateTodo)).call.apply(_ref, [this].concat(args))), _this), _this.u = function (e) {

            var num = _this.refs.num.value;
            var text = _this.refs.text.value;

            _this.props.u(num, text);
        }, _temp), _possibleConstructorReturn(_this, _ret);
    }
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement("input", { type: "text", ref: "num" })
                ),
                _react2.default.createElement(
                    "div",
                    null,
